...
h = fullfile('~',... # Change this path accordingly 
    'CA1_SimpleDetailed','Excitatory_Inhibitory_Ratios',...
...
%% IPSCs from BC and BiC onto BC, BiC, AAC

IPSC_all_on_BC_BiC_AAC_combo1 = [];
ipsc_all_on_BC_BiC_AACcombo1 = [];
for i = 1:1:3375
...
for i = 15:15:3375
    IPSC_all_on_BC_BiC_AAC_table = IPSC_all_on_BC_BiC_AAC_combo1(:,i-14:i);
    num = (1:15)';
    ...
    IPSC_all_on_BC_BiC_AAC_table.Properties.VariableNames = {'BC_and_BiC_AAC_Number', 'Mean_Peak', 'Standard_Deviation'};
end
